# Generated by Django 2.2.16 on 2022-12-21 14:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredient_amounts', to='foods.Ingredient', verbose_name='Ингрединты')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', through='foods.IngredientsAmount', to='foods.Ingredient', verbose_name='Ингредиенты')),
