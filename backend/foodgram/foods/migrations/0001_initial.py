# Generated by Django 2.2.16 on 2022-12-30 06:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe', to='foods.Ingredient', verbose_name='Связанные ингредиенты')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='ingredients', through='foods.IngredientsAmount', to='foods.Ingredient', verbose_name='Ингредиенты')),
        ...
        migrations.AddField(
            ...
            name='recipe',
            field=models.ForeignKey(help_text='Выберите рецепт', on_delete=django.db.models.deletion.CASCADE, related_name='ingredient_amounts', to='foods.Recipe', verbose_name='Название рецепта'),
        ),
        migrations.CreateModel(
            name='Follow',
            fields=[
