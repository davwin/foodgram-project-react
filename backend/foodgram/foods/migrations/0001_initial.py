# Generated by Django 3.2.16 on 2022-11-01 05:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#49B64E', image_field=None, max_length=18, samples=None, unique=True)),
            ],
            options={
                'verbose_name': 'Тэг',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.DecimalField(decimal_places=0, max_digits=2)),
                ...
                ('tags', models.ManyToManyField(related_name='recipe', to='foods.Tag')),
            ],
            options={
                'verbose_name': 'Рецепт',
